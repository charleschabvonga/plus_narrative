 ...
 */
function pn_register_cpt($name, $icon, $supports = ['title'], $type = 'post', $taxonomies = false, $public = true, $searchable = true, $slug = null, $label = null, $plural = true)
{
    $label = $label ?? $name;

    $singular = ucwords(str_replace('-', ' ', $label));
    $plural   = $plural ? PN_pluralize($singular) : $singular;
 ...
 * @return string|string[]
 */
function pn_register_taxonomies($name, $supports = [], $hierarchical = false, $public = true, $label = null, $plural = true)
{
    $label = $label ?? $name;
